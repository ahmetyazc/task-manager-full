...
export interface ApiNotificationNotification
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['task', 'team', 'workpackage']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectTaskProjectTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    users_permissions_users: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    work_packages: Schema.Attribute.Relation<
      'oneToMany',
      'api::work-package.work-package'
    >;
  };
}
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    project_task: Schema.Attribute.Relation<
      'oneToOne',
      'api::project-task.project-task'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiWorkPackageWorkPackage extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::work-package.work-package': ApiWorkPackageWorkPackage;
